<#
.SYNOPSIS
Send one or more test emails to SMTP server at localhost.

.DESCRIPTION
Used for testing fake SMTP servers, such as smtp4dev and Papercut-SMTP, used for dev testing.

Adds an attachment to the email.  Ensure the file at $attachmentFilePath exists.
...
Slightly modified version of https://github.com/rnwood/smtp4dev/blob/master/sendtestemail.ps1
