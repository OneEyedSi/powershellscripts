<#
.SYNOPSIS
Installs the specified module from PowerShell Gallery.
...
Install-Module -Name $moduleName -Repository 'PSGallery' -AllowClobber `
...
Install-Module -Name $moduleName -Repository 'PSGallery' `
    -Proxy $proxyUrl -ProxyCredential $proxyCredentials -AllowClobber